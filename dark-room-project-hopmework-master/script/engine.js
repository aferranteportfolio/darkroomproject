      ...
      setTimeout(notifyAboutSound, 3000);
		...
		travelTo: function(module) {
			if(Engine.activeModule != module) {
				...
				if(module != Outside && module != Path) {
					document.body.style.backgroundImage = "url('./utils/roombackgroundimage.jpg')";
					
				}
				if(module != Room && module != Path) {
					document.body.style.backgroundImage = "url('./utils/outsidebackgroundimage.jpg')";
					
				}
				if(module != Room && module != Outside) {
					document.body.style.backgroundImage = "url('./utils/pathbackgroundimage.jpg')";
